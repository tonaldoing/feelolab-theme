...
4. `.github/workflows/release.yml` detecta que esa versión no tiene release, verifica que las cuatro versiones coincidan, arma los zips y publica el Release con su tag `vX.Y.Z`. También se puede correr a mano desde Actions → Release → Run workflow. Los sitios lo ven en hasta 12 horas, o al instante con "Buscar de nuevo" en Actualizaciones.
